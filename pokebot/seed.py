...
DEFAULT_SHOPS: list[dict] = [
    ...
    {"key": "ludifolie", "name": "Ludifolie", "base_url": "https://www.ludifolie.com",
     "adapter": "html", "enabled": False,
     "config": {"price_selector": "[itemprop=price]", "availability_selector": ".product-quantities"},
     "note": "PrestaShop. Recherche bloquee par robots.txt -> coller une URL directe par produit."},
